...
unet = torch.load("model-expn1-10-0.4951373984254687.pth")
...
for epoch in range(epochs):
    ...
    if valid_logs['dice']>accv:
        ...
        torch.save(unet, "model-expn1-"+str(epoch)+"-"+str(accv)+".pth")

    with open('exp-n1-train.txt', 'wb') as f:
        pickle.dump(train_record, f)
'''
print("VALIDATING...")
valid_logs = valid_epoch.run(valid_loader)
valid_record.append(valid_logs)
with open('exp-n1-valid.txt', 'wb') as f:
