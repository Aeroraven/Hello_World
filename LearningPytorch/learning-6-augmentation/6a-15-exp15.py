...
unet = load_unet_weights(unet,"model-exp12-ss.pth")
unet = torch.load("model-exp15-40.pth")
...
valid_loader2 = torch.utils.data.DataLoader(valid_dataset2, batch_size=2, shuffle=True,pin_memory=True)
...
for epoch in range(epochs):
    ...
    torch.save(unet, "model-exp15-36.pth")

    with open('exp-15-train.txt', 'wb') as f:
...
valid_record.append(valid_logs)
with open('exp-15-valid.txt', 'wb') as f:
