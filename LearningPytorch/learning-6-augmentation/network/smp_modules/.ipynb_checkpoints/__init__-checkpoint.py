...
# from .resnet_twohead import resnet_encoders
from .resnet_twohead_split import resnet_encoders
...
def get_separate_encoder(name, in_channels=3, depth=5, weights=None):
